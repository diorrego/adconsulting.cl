...
const Footer = () => {
  return (
    <footer className="relative flex flex-col sm:flex-row items-center justify-between sm:item-start space-y-16 sm:space-y-0 bg-white w-full px-4 sm:px-32 xl:px-60 pt-16 pb-24 sm:pb-32">
      <div className="flex flex-row space-x-6 items-center h-fit">
        <Link href="/">
          <div className="bg-[#ED7423] w-20 h-12 flex items-center justify-center rounded-lg">
